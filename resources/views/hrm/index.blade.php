...
<div class="lb-main-page d-flex">
    <div class="left-side bg-light shadow-lg">
       <div class="shadow-lg d-flex justify-content-between align-items-center px-2 pt-2 bg-white" style="padding-bottom: 10px;">
           ...
           <div class="left-manu">
            <ul class="list-group">
                <li class="list-group-item  border-0 bg-light left-menu-item d-flex justify-content-between align-items-left"><span><i class="fa fa-dashboard" aria-hidden="true"></i> &nbsp;&nbsp;Dashboard</span></li>
...
<li class="list-group-item  border-0 bg-light left-menu-item d-flex justify-content-between align-items-left"><span><i class="fa fa-user" aria-hidden="true"></i> &nbsp;&nbsp;Profile</span></li>
<li class="list-group-item  border-0 bg-light left-menu-item d-flex justify-content-between align-items-left"><span><i class="fa fa-key" aria-hidden="true"></i> &nbsp;&nbsp;Change Password</span></li>
<li class="list-group-item  border-0 bg-light left-menu-item d-flex justify-content-between align-items-left"><span><i class="fa fa-lock" aria-hidden="true"></i> &nbsp;&nbsp;Logout</span></li>
